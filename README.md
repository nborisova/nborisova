...
На данный момент работаю ручным тестировщиком и изучаю автоматизацию на Python.<br>
Ранее немного изучала веб-разработку и реализовала несколько учебных проектов, которые можно найти у меня в профиле.
